...
clean:
	rm -rf $(HOST_OBJS) $(DEVICE_OBJS) $(HOST_TARGET) $(DEVICE_TARGET) \
		$(BSG_MANYCORE_LIB_OBJS) $(BSG_MANYCORE_LIB) $(CRT_LIB)
...
$(DEVICE_TARGET): $(DEVICE_OBJS) $(BSG_MANYCORE_LIB) $(CRT_LIB)
	$(RISCV_LINK) $(RISCV_LINK_OPTS) -L. \
		$(DEVICE_OBJS) $(BSG_MANYCORE_LIB) -o $@

$(DEVICE_OBJS) $(BSG_MANYCORE_LIB_OBJS): %.o: %.c
